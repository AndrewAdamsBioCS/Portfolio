...
<nav class = "sidebar">
	<a class="sb-nav-link active" id="cs-link" onclick="toggleWorkDiv('cs-div')">Computer science</a>
	<a class="sb-nav-link" id="lab-link" onclick="toggleWorkDiv('lab-div')">Laboratory work</a>
	<a class="sb-nav-link" id="other-link" onclick="toggleWorkDiv('other-div')">Other</a>
</nav>

<div class="work-div" id="cs-div">
	<div class="experience-div">
		...
		<div style = "padding: 10px;">
			<ul>
			<li>Updated testing software to improve efficiency of data collection; developed product software for desktop user interface, web portal connectivity, and control of peripheral device behavior</li>

			<li>Developed scripts to process multiple features of large data sets based on device measurements; performed statistical analysis of data features for calibration of device sensor</li>

			<li>Researched machine learning techniques</li>
			</ul>
		</div>

		<p><strong>Skills</strong>: Python, C#, ASP.NET, data analysis, statistics, AI / machine learning</p>

		<p><a href="http://metabolicinsights.com" target="_blank">metabolicinsights.com</a></p>
	</div>

	<div class="experience-div">
		<h1>United States Air Force</h1>
		<p><i>Computer Network Technician</i></p>
		<p>2010 - 2012</p>

		<div style = "margin: 15px; padding: 10px; border: 1px black dotted;">
		Served as an enlisted airman in the field of Cyber Systems Operations. From the official US Air Force website: "The Air Force relies heavily on advanced computer and software systems, so it is paramount to keep those systems safe. It's the job of Cyber Systems Operations specialists to design, install and support our systems to ensure they operate properly and remain secure from outside intrusion."
		</div>

		<div style = "padding: 10px;">
			<ul>
			<li>Maintained and supported multiple computer systems used by military intelligence, including specialized software suites and top secret intranet systems</li>

			<li>Manually installed individual workstations and connected them to secure network; configured, monitored, and serviced network servers</li>

			<li>Administered internal web-based hubs (such as Microsoft Sharepoint) for information sharing</li>
			</ul>
		</div>

		<p><strong>Skills</strong>: Server configuration/maintenance, networking, desktop installation </p>
	</div>
</div> <!-- End cs-div -->

<div class="work-div" id="lab-div" style="display: none;">
	<div class="experience-div">
...
Prepared mineral/soil samples for testing; received sample shipments into inventory; assisted in laboratory work (weighing samples, measuring pH, adding chemical reagents, cleaning and setting up test equipment)

Contributed to laboratory upgrade projects, such as construction of new work spaces; performed in-house fabrication of testing equipment; assisted in repair of machines

Maintained integrity of test results by adhering to good quality control principles in the handling of samples; archived inventory in orderly manner for future retrieval
</div>
